...
а company website и geo исключить из перебора.
...
/*Object.defineProperties(listArray, {
    "name": { writable: false },
...
/*for (let key in listArray) {
    Object.defineProperty(listArray, [key].website, { enumerable: false });
    console.log(`${key}: ${listArray[key].website}`);
}*/
///////////////////////////////////////////////////
/*Object.defineProperty(listArray, "website", {
    enumerable: false
});*/
/////////////////////////////////////////////
for (var key in listArray) {
    Object.freeze(listArray[key].name);
    Object.freeze(listArray[key].phone);
    delete listArray[key].company;
...
var importTo = document.querySelector('.article');
for (var a = 0; a < listArray.length; a++) {
    createPost(listArray[a], importTo);
};
